            ...
            <div>
                ...
                <div className="unsubscribe-reasons">
                    ...
                    <div>
                        ...
                        <div>
                            <label> <input type="radio" id="too-many" name="other" value="tooMany" checked={this.state.value === "tooMany"} onChange={this.handleRadioChange} />
                                Too many emails</label>
                        </div>
                        <div>
                            <label> <input type="radio" id="not-signed" name="other" value="notSiged" checked={this.state.value === "notSiged"} onChange={this.handleRadioChange} />
                                I didn't sign up for this</label>
                        </div>
                        <div>
                            <label><input type="radio" id="other" name="other" value="other" checked={this.state.value === "other"} onChange={this.handleRadioChange} />
                                Other</label>
                            {<OtherReason />}
                        </div>
                    </div>
